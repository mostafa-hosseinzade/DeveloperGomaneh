...
public class PortfolioController implements Serializable {
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("PortfolioCreated"));
    ...
    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("PortfolioDeleted"));
        if (!JsfUtil.isValidationFailed()) {
