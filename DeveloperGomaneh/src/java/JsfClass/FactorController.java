...
public class FactorController implements Serializable {
    ...
    @EJB
    private Bean.FactorFacade ejbFacade;
    private List<Factor> items = null;
    ...
    private FactorFacade getFacade() {
        return ejbFacade;
    }
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("FactorCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("FactorUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("FactorDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Factor getFactor(java.lang.Integer id) {
